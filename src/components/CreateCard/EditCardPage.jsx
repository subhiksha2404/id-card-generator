...
export default function EditCardPage() {
    ...
    const loadCard = async () => {
        try {
            const data = await db.getCard(id);
            setFormData({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await db.updateCard(id, formData, photoFile, signatureFile);
            navigate('/');
        } catch (err) {
            console.error(err);
        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="max-w-5xl mx-auto">
                    <h1 className="text-2xl font-bold text-slate-900 mb-8">Edit ID Card</h1>
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 items-start">
                                ...
                                <div>
                                    ...
                                    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-300 border-dashed rounded-lg hover:bg-slate-50 transition-colors cursor-pointer relative">
                                        <div className="space-y-1 text-center">
                                            {photoPreview ? (
                                                <img src={photoPreview} alt="Preview" className="mx-auto h-20 w-20 object-cover rounded-full mb-2" />
                                            ) : (
                                        ...
                                        <div className="mt-1 flex items-center gap-4">
                                            <div className="flex-1">
                                                <label className="flex justify-center px-6 pt-5 pb-6 border-2 border-slate-300 border-dashed rounded-lg hover:bg-slate-50 transition-colors cursor-pointer relative">
                                                    <div className="space-y-1 text-center">
                                                        <div className="flex text-sm text-slate-600 justify-center">
                                                            <span className="font-medium text-blue-600 hover:text-blue-500">Change Signature</span>
                                                            <input
                                                                type="file"
                                                                className="absolute inset-0 w-full h-full opacity-0 cursor-pointer"
                                                                accept="image/*"
                        ...
                        <div className="lg:sticky lg:top-24 space-y-4">
                            ...
                            <p className="text-sm text-slate-500 text-center">
                                This is how the updated ID card will look.
                            </p>
                        </div>
                    </div>
                </div>
